...
} from "../constants/treatmentSchema";
...
export type TreatmentDTO = z.infer<typeof TreatmentResponseSchema>;
...
export type TreatmentRequestDTO = z.infer<typeof TreatmentRequestSchema>;
